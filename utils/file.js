...
/**
 * the module with file utilities
 */
const fileUtils = {
  /**
   * this validates if body is valid for creating file
  ...
  /**
   * this method gets file document from db
  ...
  /**
   * this metod gets list of file documents from db belonging
   * to a parent id
   * @query {obj} query used to find file
  ...
  /**
   * this saves files to database and disk
  ...
  /**
   * tis updates a file document in database
  ...
  /**
   * this makes a file public or private
   * @request {request_object} express request obj
  ...
  /**
   * this ransforms _id into id in a file document
   * @doc {object} document to be processed
   * @return {object} processed document
   */
  processFile(doc) {
    // this changes _id for id and removes localPath
  ...
  /**
   * this checks if a file is public and belongs to a
   * specific user
  ...
  /**
   * this gets a files data from database
